...
int gener_id;
int year_id;
public Movielist(int id, int movie_name, int audience_score, float profitability, int roten_tomatos,
		double worldwide_gross, int lead_studio_id, int gener_id, int year_id) {
	super();
	this.id = id;
...
public int getMovie_name() {
	return movie_name;
}
public void setMovie_name(int movie_name) {
	this.movie_name = movie_name;
}
...
public int hashCode() {
	...
	result = prime * result + movie_name;
...
public String toString() {
	return String.format("%d %s",id,movie_name );
}
}
